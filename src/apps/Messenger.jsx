...
const contacts = [
  ...
  { name: "sk8punk_alex", status: "online", avatar: "🎸" },
...
const conversations = {
  ...
  "sk8punk_alex": [
    { from: "sk8punk_alex", text: "hey!! u like blink-182 too?? i saw ur profile" },
    { from: "you", text: "YES omg enema of the state is the best album ever" },
    { from: "sk8punk_alex", text: "DUDE same. where r u from??" },
    { from: "you", text: "argentina. u?" },
    { from: "sk8punk_alex", text: "ohio lol. literally the other side of the world" },
    { from: "you", text: "haha yeah we would never meet just walking around" },
    { from: "sk8punk_alex", text: "right?? like theres ZERO chance we would ever cross paths irl" },
    { from: "sk8punk_alex", text: "but here we are talking at 2am because we both love the same band" },
    { from: "you", text: "its crazy when u think about it" },
    { from: "sk8punk_alex", text: "and like... we're gonna keep talking" },
    { from: "sk8punk_alex", text: "and stay up late sharing songs and talking about stupid stuff" },
    { from: "you", text: "and become actual friends" },
    { from: "sk8punk_alex", text: "and burn cds for each other and mail them across the continent" },
    { from: "you", text: "and go to concerts when we're older" },
    { from: "sk8punk_alex", text: "and grow up together kinda. even tho we're so far away" },
    { from: "you", text: "..." },
    { from: "sk8punk_alex", text: "the internet is weird and beautiful sometimes" },
    { from: "you", text: "yeah. it really is" },
    { from: "sk8punk_alex", text: "ok brb my mom is yelling at me to get off the computer" },
    { from: "you", text: "lol same. talk tomorrow?" },
    { from: "sk8punk_alex", text: "always 🤘" },
  ],
  "techbro_jake": [
